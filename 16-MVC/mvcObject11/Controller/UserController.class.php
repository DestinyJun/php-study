...
final class UserController extends BaseController{
  ...
  public function index() {
    ...
    try {
      self::$smarty->display('./View/User/index.html');
    } catch (Exception $e) {
      echo '<pre>';
      print_r($e);
    }
  ...
  public function add() {
    //（3）调用添加页面的视图数据
    try {
      self::$smarty->display('./View/User/add.html');
    } catch (Exception $e) {
      echo '<pre>';
      print_r($e);
    }
  ...
  public function insert() {
    ...
    if ($UserModelObj->fetchInsert($arr)) {
      $this->jump('添加成功','?c=User','2');
    } else {
      $this->jump('添加失败','?c=User','2');
    }
  }
  // 显示编辑表单
  public function edit() {
    ...
    try {
      self::$smarty->display('./View/User/edit.html');
    } catch (Exception $e) {
      echo '<pre>';
      print_r($e);
    }
