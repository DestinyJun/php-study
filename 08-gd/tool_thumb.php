<?php
/**
 * @param $thumbnail_w number 所要显示缩略图的宽
 * @param $thumbnail_h number 所要显示缩略图的高
 * @param $src_file string 取样图片的资源路径
 */
function tool_thumb($thumbnail_w,$thumbnail_h,$src_file) {
  // 创建缩略图画布
